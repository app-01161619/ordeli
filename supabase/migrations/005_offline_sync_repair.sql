-- Ordeli: repair/normalize the offline order sync RPC and force PostgREST
...
grant execute on function public.sync_offline_order(text, text, text, uuid, text, text, integer, numeric)
to authenticated;
